...
export const siteBackgroundClass =
  "bg-[radial-gradient(circle_at_top_left,#f5e2d1_0%,#f7f1e9_30%,#eef3f7_68%,#e8eef4_100%)]";
    ...
    <header className="sticky top-0 z-50 px-4 py-4">
      <div
        className={cn(
          ...
          "flex items-center justify-between gap-4 rounded-[28px] border border-white/75 bg-[rgba(255,251,246,0.78)] px-5 py-3 shadow-[0_18px_45px_rgba(15,23,42,0.08)] backdrop-blur-xl",
        )}
      >
    ...
    <footer className={cn("relative z-10 px-6 pb-8 pt-12", className)}>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-400">Lazy Resume</p>
            <p className="mt-1 text-lg font-semibold text-slate-900">懒人简历让优化、套版和导出尽量少动手。</p>
          </div>
        </div>
...
export default function SiteFrame({
  ...
  return (
    <div className={cn("relative min-h-screen overflow-x-hidden text-slate-900", siteBackgroundClass, className)}>
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[460px] bg-[radial-gradient(circle_at_top_left,rgba(184,92,44,0.18),transparent_44%),radial-gradient(circle_at_top_right,rgba(255,255,255,0.78),transparent_40%)]" />
      ...
      <div className="pointer-events-none absolute inset-x-0 top-[26rem] h-px bg-[linear-gradient(90deg,transparent,rgba(184,92,44,0.18),transparent)]" />
